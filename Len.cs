...
namespace YTCFW
{
    ...
    public class Len
    {
        ...
        private string CenterTextInBuffer(string text, int bufferWidth)
        {
            ...
            {
                int leftPadding = (bufferWidth - line.Length) / 2;
                leftPadding = Math.Max(leftPadding, 0); // Ensure padding is not negative

                centeredText.AppendLine(new string(' ', leftPadding) + line);
            }
