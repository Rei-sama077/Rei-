...
namespace YTCFW
{
    public class Tablever2
    {
        ...
        public void hders(params string[] headers)
        {
            _headers = headers;
        }
        ...
        private StringBuilder CreatehdersLine(int[] maximumCellWidths, int previousRowColumnCount, int rowColumnCount, StringBuilder formattedTable)
        {
        ...
        public override string ToString()
        {
            ...
            for (int i = 0; i < table.Count; i++)
            {
                ...
                if (rowIndex != lastRowIndex)
                {
                    ...
                    formattedTable = CreatehdersLine(maximumCellWidths, previousRow.Count(), nextRow.Count(), formattedTable);
                }
                rowIndex++;
            }
